...
cd /d C:\Users\server\Documents\Nexora\nexora-site
...
echo [8/21] Starting WhatsApp Partner Worker 1...
...
echo [9/21] Starting WhatsApp Partner Worker 2...
...
echo [10/21] Starting Router WhatsApp 1...
...
echo [11/21] Starting Router WhatsApp 2...
...
echo [12/21] Starting User Text Specialist 1...
...
echo [13/21] Starting User Text Specialist 2...
...
echo [14/21] Starting User Text Specialist 3...
...
echo [15/21] Starting User Text Specialist 4...
...
echo [16/21] Starting User Text Specialist 5...
...
echo [17/21] Starting User Text Specialist 6...
...
echo [18/21] Starting Telegram Bot 1...

start "NEXORA Telegram Bot 1" cmd /k "python -m bots.lead-demo"

timeout /t 5 /nobreak >nul


echo [19/21] Starting Telegram Bot 2...

start "NEXORA Telegram Bot 2" cmd /k "python -m bots.lead-demo2"

timeout /t 5 /nobreak >nul


echo [20/21] Starting WhatsApp Bot 1...
...
echo [21/21] Starting WhatsApp Bot 2...
...
echo       SPECIALISTS 1-6 ENABLED

echo       TELEGRAM + WHATSAPP ENABLED

echo       ALL BOTS STARTED LAST
