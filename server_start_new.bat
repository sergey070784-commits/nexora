...
echo [6/15] Starting Partner Worker Bot 1...
...
echo [7/15] Starting Partner Worker Bot 2...
...
echo [10/15] Starting WhatsApp Contact Worker 1...
...
echo [11/15] Starting WhatsApp Contact Worker 2...
